...
const Footer = () => {
    return (
        <div className='mt-12'>
            <footer class="footer p-10 md: grid grid-cols-2  text-base-content bg-purple-100">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-secondary text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p className='text-center'>Plumber Industries Ltd. <span className='text-center'>Providing reliable service since 1990 </span></p>
                </div>
